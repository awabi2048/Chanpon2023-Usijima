...
# Slayer → 検索, 
data modify storage usjm:index Search.in set from storage usjm:quest Search.out.Subject.Target
...
execute if data storage usjm:quest {Search:{out:{Format:"Fetch"}}} run tellraw @s ["\uF824\uF822\uF829",{"text": "目標","underlined": true},{"text": ":\uF824","underlined": false},{"nbt":"Display.Subject[0]","storage": "usjm:quest","interpret": true,"color": "white","bold": true},{"text": "の納品\uF824«0/"},{"nbt":"Display.Main.Subject.Count","storage": "usjm:quest"},{"text": "の納品\uF824","color": "#dddddd"},{"text": "(","color": "#dddddd"},{"text": "0","color": "#aaaaff"},{"text": "/","color": "gray"},{"nbt":"Display.Main.Subject.Count","storage": "usjm:quest","color": "gray"},{"text": ")","color": "#dddddd"}]
