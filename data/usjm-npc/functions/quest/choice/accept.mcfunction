...
data modify storage usjm:index Search.in set from storage usjm:npc NPCData.Current[0]
...
tellraw @s [{"text": "［","color": "white"},{"nbt":"AcceptedType","storage": "usjm:quest","interpret": true},{"text": "］","color": "white"},"\uF824",{"text": "『","color": "white","bold": true},{"nbt":"Search.out.DisplayName","storage": "usjm:quest","bold": true,"interpret": true,"color": "white"},{"text": "』","color": "white","bold": true},{"text": "を受注しました！","color": "#ffffbb"}]
